...
namespace QL_DiemTHPT
{
    public partial class FrmQLGIAOVIEN : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qL_DIEMTHPTDataSet2.GIAOVIEN' table. You can move, or remove it, as needed.
            this.gIAOVIENTableAdapter2.Fill(this.qL_DIEMTHPTDataSet2.GIAOVIEN);
            // TODO: This line of code loads data into the 'qL_DIEMTHPTDataSet1.GIAOVIEN' table. You can move, or remove it, as needed.
            this.gIAOVIENTableAdapter1.Fill(this.qL_DIEMTHPTDataSet1.GIAOVIEN);
